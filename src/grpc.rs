// raft_service_server -> server modules
// raft_service_client -> client modules
// Both generated by codegen
// RaftService - trait holding all the contracts in server module
// RaftServiceServer - The tower adaptor
